...
#k='UVvis_T_%d_%d' %(en0, en1)

wl0, wl1=(400, 925)
inds=numpy.where((wl>wl0)&(wl<wl1))
k='UVvis_T_%d_%d' %(wl0, wl1)

dwl=wl[1:]-wl[:-1]
dwl=numpy.concatenate([dwl, [dwl[-1]]])
dwl=numpy.abs(dwl)

dwl_inds=dwl[inds]
intfcn=lambda arr:(arr[inds]*dwl_inds).sum()/dwl_inds.sum()

dwlam15_inds=W_m2_nm[inds]*dwl[inds]

intfcn_am15=lambda arr:(arr[inds]*dwlam15_inds).sum()/dwlam15_inds.sum()


k_am15='UVvis_Ten_%d_%d_am1.5' %(wl0, wl1)

k3='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__I677mV'

k4='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__I627mV'
k4b='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__0.3cutI627mV'
k4c='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__0.23cutI627mV'

k5='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__I577mV'

k5b='UVvis_Ten_%d_%d_am15' %(wl0, wl1)+'__0.1cutI577mV'
