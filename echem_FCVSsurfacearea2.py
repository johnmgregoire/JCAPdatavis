...
#p2=''
#vrange=(-.19, -.14)
vscanrangefrac=(.15, .85)

vendrangefrac=(.02, .98)#used to test where the endpoints of the scan are located - should not need to be changed
vendtol=0.01# the V difference between the test points and the usbale part of the scan
...
#if isinstance(d['Sample'], numpy.ndarray):
#    smp=d['Sample'][0]
#else:
#    smp=d['Sample']
